...
const GET_MAKES_API = 'CoverLo_GetMakeLists';
const GET_MAKES_BY_PRODUCT_API = 'CoverLo_GetMakeListsByProductCode';
const GET_MODELS_API = 'CoverLo_GetModelLists';
const GET_MODELS_BY_PRODUCT_API = 'CoverLo_GetModelListsByProductCode';
const GET_PRODUCTS_API = 'CoverLo_GetProducts';
const GET_PROFESSIONS_API = 'CoverLo_GetProfessions';
const GET_TRACKING_COMPANIES_API = 'CoverLo_GetTrackingCompanies';
const GET_COLORS_API = 'CoverLo_GetColors';
